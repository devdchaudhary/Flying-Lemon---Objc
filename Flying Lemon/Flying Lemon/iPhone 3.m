...
-(void)LemonMoving{
    ...
    Lemon.center = CGPointMake(Lemon.center.x, Lemon.center.y - Lemonflying3);
    
    Lemonflying3 = Lemonflying3 - 5;
...
-(void)PlaceTunnels{
    ...
    RandomUpperTunnelPosition3 = arc4random() %270;
    RandomUpperTunnelPosition3 = RandomUpperTunnelPosition3 - 250;
    RandomLowerTunnelPosition3 = RandomUpperTunnelPosition3 + 765;
    
    TopTunnel.center = CGPointMake(900, RandomUpperTunnelPosition3);
    BottomTunnel.center = CGPointMake(900, RandomLowerTunnelPosition3);
...
-(void)Gameover {
    ...
    if (ScoreNumber1iphone > HighScoreNumber) {
        [[NSUserDefaults standardUserDefaults] setInteger:ScoreNumber1iphone forKey:@"HighScoreSaved"];
    }
...
-(void)Score {
    ...
    ScoreNumber1iphone = ScoreNumber1iphone + 1;
    
    ScoreLabel.text = [NSString stringWithFormat:@"%i", ScoreNumber1iphone];
